...
% set the values
opts.opencv_include_path    =   'D:\Libs\OpenCV\2.4.9\build\include'; % OpenCV include path
opts.opencv_lib_path        =   'D:\Libs\OpenCV\2.4.9\build\x64\vc12\lib'; % OpenCV lib path
