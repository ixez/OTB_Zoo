...
input_layers={};
if enable_conv2
    input_layers=[input_layers,'conv_23'];
end
if enable_conv1
    input_layers=[input_layers,'conv_11'];
end
if enable_conv3
    input_layers=[input_layers,'conv_31'];
end

net_online.addLayer('sum1',dagnn.Sum(),input_layers,'sum_1');
